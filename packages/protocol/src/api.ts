...
import { makeModelCallGroup } from "./groups/model-call"
import { makeTeamGroup } from "./groups/team"
...
>(
  ...
  HttpApi.make("server")
    ...
    .add(makeModelCallGroup(sessionLocationMiddleware))
    .add(makeTeamGroup(sessionLocationMiddleware))
