...
type Endpoint4_0Request = Parameters<RawClient["server.modelCall"]["modelCall.list"]>[0]
type Endpoint4_0Input = { readonly sessionID: Endpoint4_0Request["params"]["sessionID"] }
const Endpoint4_0 = (raw: RawClient["server.modelCall"]) => (input: Endpoint4_0Input) =>
  raw["modelCall.list"]({ params: { sessionID: input["sessionID"] } }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

type Endpoint4_1Request = Parameters<RawClient["server.modelCall"]["modelCall.get"]>[0]
type Endpoint4_1Input = {
  readonly sessionID: Endpoint4_1Request["params"]["sessionID"]
  readonly callID: Endpoint4_1Request["params"]["callID"]
}
const Endpoint4_1 = (raw: RawClient["server.modelCall"]) => (input: Endpoint4_1Input) =>
  raw["modelCall.get"]({ params: { sessionID: input["sessionID"], callID: input["callID"] } }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

type Endpoint4_2Request = Parameters<RawClient["server.modelCall"]["modelCall.cancel"]>[0]
type Endpoint4_2Input = {
  readonly sessionID: Endpoint4_2Request["params"]["sessionID"]
  readonly callID: Endpoint4_2Request["params"]["callID"]
}
const Endpoint4_2 = (raw: RawClient["server.modelCall"]) => (input: Endpoint4_2Input) =>
  raw["modelCall.cancel"]({ params: { sessionID: input["sessionID"], callID: input["callID"] } }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

type Endpoint4_3Request = Parameters<RawClient["server.modelCall"]["modelCall.detach"]>[0]
type Endpoint4_3Input = {
  readonly sessionID: Endpoint4_3Request["params"]["sessionID"]
  readonly callID: Endpoint4_3Request["params"]["callID"]
}
const Endpoint4_3 = (raw: RawClient["server.modelCall"]) => (input: Endpoint4_3Input) =>
  raw["modelCall.detach"]({ params: { sessionID: input["sessionID"], callID: input["callID"] } }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

const adaptGroup4 = (raw: RawClient["server.modelCall"]) => ({
  list: Endpoint4_0(raw),
  get: Endpoint4_1(raw),
  cancel: Endpoint4_2(raw),
  detach: Endpoint4_3(raw),
})

type Endpoint5_0Request = Parameters<RawClient["server.team"]["team.status"]>[0]
type Endpoint5_0Input = { readonly sessionID: Endpoint5_0Request["params"]["sessionID"] }
const Endpoint5_0 = (raw: RawClient["server.team"]) => (input: Endpoint5_0Input) =>
  raw["team.status"]({ params: { sessionID: input["sessionID"] } }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

type Endpoint5_1Request = Parameters<RawClient["server.team"]["team.stop"]>[0]
type Endpoint5_1Input = {
  readonly sessionID: Endpoint5_1Request["params"]["sessionID"]
  readonly member?: Endpoint5_1Request["payload"]["member"]
  readonly force?: Endpoint5_1Request["payload"]["force"]
}
const Endpoint5_1 = (raw: RawClient["server.team"]) => (input: Endpoint5_1Input) =>
  raw["team.stop"]({
    params: { sessionID: input["sessionID"] },
    payload: { member: input["member"], force: input["force"] },
  }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

const adaptGroup5 = (raw: RawClient["server.team"]) => ({ status: Endpoint5_0(raw), stop: Endpoint5_1(raw) })
...
const adaptClient = (raw: RawClient) => ({
  ...
  modelCall: adaptGroup4(raw["server.modelCall"]),
  teams: adaptGroup5(raw["server.team"]),
